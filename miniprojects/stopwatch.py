#http://www.codeskulptor.org/#user38_1H3p0O5RVS_0.py
...
def draw_stopwatch(canvas):
    canvas.draw_text(format(timer_int), [width/4, height/2.5], width/6, "White")
    canvas.draw_text(str(success_stop) + "/" + str(total_stop), (width/1.70, height/5), width/15, "Red")
##########################################################
